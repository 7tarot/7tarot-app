...
// 7TAROT — Shop Only (Big Cartel powered)
...
async function init() {
  try {
    ...
    console.error(e);
    grid.innerHTML = '<div style="padding:24px;color:#ffb3b3">Could not load products. If this persists, CORS may be blocking api.bigcartel.com from your domain. I can give you a tiny Netlify proxy if needed.</div>';
  }
